...
VALUES	('John Doe', 'johndoe@gmail.com'),
		('Angela Smith', 'angelasmith@gmail.com'),
		('Jackson Ava', 'jacksonava@gmail.com'),
		('Oliver Ruby', 'oliverruby@hotmail.com'),
		('Daniel Lily', 'diniellily@gmail.com');

INSERT INTO reservations(reservationTime, numberOfGuests, specialRequests, customerId) 
VALUES	('2024-05-20 19:00:00', 2, 'Window seat preferred',1),
		('2024-05-21 20:00:00', 4, 'Allergic to peanuts',2),
		('2024-05-22 18:30:00', 3, 'Celebrating anniversary',3),
		('2024-05-23 19:45:00', 5, 'Need high chair for a toddler',4),
		('2024-05-24 20:30:00', 2, 'Vegetarian meal options',5);

INSERT INTO diningPreferences(favoriteTable, dietaryRestrictions, customerId) 
VALUES  ('Table 5', 'None',1),
		('Table 9', 'Gluten-free',2),
		('Table 20', 'Vegetarian',3),
		('Table 15', 'No dairy',4),
		('Table 1', 'Vegan',5);
